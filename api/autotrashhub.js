...
export default function handler(req, res) {
  ...
  if (!isBrowser) {
    ...
    if (/curl|wget|powershell/i.test(ua)) {
      ...
      res.writeHead(302, { Location: "https://luexteamscript.vercel.app/auto-trash-dscsdcbsjkcbfcjscbdjscgdjskdfcgjkdxsdcdscds.lua" });
      res.end();
    }
  } else {
    // Browser -> redirect UI
    res.writeHead(302, { Location: "/autotrashcan" });
    res.end();
  }
}
